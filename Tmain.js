...
function submit()
{
    ...
    // Begin for loop as: for (var j = 1; j <= 4; j++) 
    {
    ...
    //begin for loop as: for (var k = 0; k < lenght_of_name_of_students_array; k++) 
    {
...
//Hide the submit button and show the sort button.
...
function sorting()
{
    //Use sort() function as: name_of_the_student_array.sort();
    ...
    // Use for loop as: for (var k = 0; k < lenght_of_name_of_students_array; k++) 
    {
